//виджет выбора класса которому задать домашку
...
export const ComboboxDemo = ({ selectedClasses, onClassesChange, hasError = false }: ComboboxDemoProps) => {
        ...
        <div className='space-y-2'>
            <Popover open={open} onOpenChange={setOpen}>
                <PopoverTrigger asChild>
                    <Button
                        variant='outline'
                        className={`w-full justify-center ${hasError ? 'border-red-500 focus:border-red-500' : ''} `}
                    >
                        {selectedClasses.length > 0 ? '+ Добавить класс' : 'Выбрать класс'}
                    </Button>
                </PopoverTrigger>
