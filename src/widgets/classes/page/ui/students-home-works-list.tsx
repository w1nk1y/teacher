...
//страница класса с инфой про полученные домашки
//после нажатия на иконку класса на главной странице
        ...
        <TableBody>
          {HomeWorkData.map((HomeWork) => (
            <TableRow
              ...
              onClick={() => router.push("/homework/view")}
            >
...
//когда бэк подключим надо брать кол-во учеников и считать сколько сдало дз из класса
